/* global define, MOLO*/
    ...
    jRange.prototype = {
        ...
        template: ['<div class="slider-container">',
            ...
            '<div class="pointer high btn-play btn-single"></div><div class="pointer-label"></div>',
        ...
        onDrag: function(pointer, e) {
            ...
            var position = e.originalEvent.changedTouches[0].clientX - this.domNode.offset().left;
        ...
        barClicked: function(e) {
            ...
            var pointer = 0;
            var x = e.originalEvent.changedTouches[0].clientX - this.clickableBar.offset().left;
            if (this.isSingle()){
                pointer = this.pointers.last();
                this.setPosition(pointer, x, true, true);
            }else {
                pointer = Math.abs(parseInt(this.pointers.first().css('left'), 10) - x + this.pointers.first().width() / 2) < Math.abs(parseInt(this.pointers.last().css('left'), 10) - x + this.pointers.first().width() / 2) ?
        ...
        onChange: function(e, self, pointer, position) {
            ...
            self.options.ondragchange.call(self, self.options.value);
        },
